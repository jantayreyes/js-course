...
function checkWiner (averageDolphins, averageKoalas) {
  if (averageDolphins >= 2 * averageKoalas) {
    console.log(`Dolphins won the game (${averageDolphins} vs. ${averageKoalas})`);
  } else if (averageKoalas >= 2* averageDolphins) {
    console.log(`Koalas won the game (${averageKoalas} vs. ${averageDolphins})`);
  } else {
    console.log('Neither team won the game');
  }
}
